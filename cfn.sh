...
aws cloudformation update-stack --stack-name mystack --template-body C:\Users\user\devops\ec2.yml --parameters ParameterKey=ImageName,ParameterValue=ami-053b0d53c279acc90
